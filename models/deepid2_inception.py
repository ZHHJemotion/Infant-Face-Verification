...
class DeepID2_Inception(nn.Module):
    def __init__(self, num_classes=2):
        super(DeepID2_Inception, self).__init__()
    ...
    def forward(self, x, y):
        ...
        aux_diff_feat, diff_feat = self.Inception(diff_feat)

        return fc_feat_1, fc_feat_2, aux_diff_feat, diff_feat

        # torch.cat(cls_preds, dim=1), torch.cat(reg_preds, dim=1)
